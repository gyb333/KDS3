...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 下拉按钮生成器
    /// </summary>
    internal class DropDownButtonBuild : ControlBuildBase
    {
        public DropDownButtonBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        protected override void SetAttributes()
        {
            ...
            if (control.CustomClose) sbProps.AppendFormat("{0},", "customClose:true");
