...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 组合按钮生成器
    /// </summary>
    internal class ComboButtonBuild : ControlBuildBase
    {
        public ComboButtonBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            ComboButton control = this.ControlHost.Content as ComboButton;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/ComboButton");
