...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 单选框生成器
    /// </summary>
    internal class RadioBoxBuild : ControlBuildBase
    {
        public RadioBoxBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
