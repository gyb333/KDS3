...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 下拉多选框生成器
    /// </summary>
    internal class CheckedMultiSelectBuild : ControlBuildBase
    {
        public CheckedMultiSelectBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            CheckedMultiSelect control = this.ControlHost.Content as CheckedMultiSelect;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/CheckedMultiSelect");
        ...
        {
            CheckedMultiSelect control = (CheckedMultiSelect)this.ControlHost.Content;
