...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 日期时间选择框生成器
    /// </summary>
    internal class DateTimeTextBoxBuild : ControlBuildBase
    {
        public DateTimeTextBoxBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            DateTimeTextBox control = this.ControlHost.Content as DateTimeTextBox;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/DateTimeTextBox");
