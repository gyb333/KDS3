...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 图形坐标Y生成器
    /// </summary>
    internal class ChartAxisYBuild : ControlBuildBase
    {
        public ChartAxisYBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            ChartAxisY control = this.ControlHost.Content as ChartAxisY;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/Charting/YAxis");
            if (!this.IsPreview)
            {
                ...
                else this.HtmlWriter.AddAttribute("name", "y");
            }

            this.HtmlWriter.AddAttribute("class", "axis");
            this.HtmlWriter.AddAttribute("vertical", "true");
            ...
            if (control.LeftBottom == EChartAxisYPosition.Right) this.HtmlWriter.AddAttribute("leftBottom", "false");
