...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// Web浏览器生成器
    /// </summary>
    internal class WebBrowserBuild : ControlBuildBase
    {
        public WebBrowserBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            WebBrowser control = this.ControlHost.Content as WebBrowser;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/WebBrowser");
            ...
            {
                this.HtmlWriter.AddAttribute("url", control.Value);
            }
