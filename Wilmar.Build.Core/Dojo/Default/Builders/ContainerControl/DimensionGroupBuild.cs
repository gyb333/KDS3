...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 维度组生成器
    /// </summary>
    internal class DimensionGroupBuild : ContainerBuildBase
    {
        public DimensionGroupBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
