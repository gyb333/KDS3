...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 度量面板生成器
    /// </summary>
    internal class MeasurePaneBuild : ContainerBuildBase
    {
        public MeasurePaneBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            MeasurePane control = this.ControlHost.Content as MeasurePane;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/MeasurePane");
