...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 堆叠控件生成器
    /// </summary>
    internal class StackPanelBuild : ContainerBuildBase
    {
        public StackPanelBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            StackPanel control = this.ControlHost.Content as StackPanel;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/StackPanel");
