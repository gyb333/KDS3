...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// BoxPane控件生成器
    /// </summary>
    internal class BoxPaneBuild : ContainerBuildBase
    {
        public BoxPaneBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            BoxPane control = this.ControlHost.Content as BoxPane;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/Box");
            ...
            sbProps.AppendFormat("title:'{0}',", this.ControlHost.Title);
