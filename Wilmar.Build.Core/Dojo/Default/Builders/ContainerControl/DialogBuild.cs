...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 对话框生成器
    /// </summary>
    internal class DialogBuild : ContainerBuildBase
    {
        public DialogBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
        ...
        {
            Dialog control = this.ControlHost.Content as Dialog;
            this.HtmlWriter.AddAttribute("dojoType", "Controls/Dialog");
