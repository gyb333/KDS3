...
namespace Wilmar.Build.Core.Dojo.Default.Builders
{
    ...
    /// 面板控件生成器
    /// </summary>
    internal class IframeBuild : ContainerBuildBase
    {
        public IframeBuild(bool isPreview, ControlHost controlHost, ScreenDefinition screenDef, CompileBase compile, ProjectDocument doc, Dictionary<int, Tuple<int, string>> permissionData, HtmlTextWriter htmlWriter)
